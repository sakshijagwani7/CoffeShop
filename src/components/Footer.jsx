            ...
            <div className='bg-black/40 min-h-[400px]'>
                <div className='max-w-7xl mx-auto grid md:grid-cols-3 pb-20 pt-5'>
                    ...
                    <div className='py-8 px-4'>
                        <a href="#" className='font-semibold tracking-widest text-2xl sm:text-3xl font-cursive'>Pure Brew</a>
                        <p className='pt-4'>Bold Brews, Warm Smiles, Lasting Memories.</p>
                    </div>
                    {/* Footer links */}
                    <div className='col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10'>
                        <div className='py-8 px-4'>
                            <h1 className='text-xl font-semibold mb-4 sm:text-left'>
                                Quick Links
                            </h1>
                    ...
                    <div className='py-8 px-4 col-span-2 sm:col-auto'>
                        ...
                        <div>
                            <p className='mb-3'>PureBrew Coffee House
                                123 Brew Street, Downtown City, NY 10001</p>
                            <p>+91 12345467890</p>
                            {/* Social Links */}
